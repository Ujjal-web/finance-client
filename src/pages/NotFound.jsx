...
const NotFound = () => {
  return (
    <StyledWrapper className="bg-base-100 text-base-content min-h-screen flex flex-col items-center justify-center">
      ...
      <div className="mt-8 text-center">
        <h2 className="text-2xl font-bold text-base-content mb-4">Page Not Found</h2>
        <p className="text-base-content/70 mb-6">The page you're looking for doesn't exist.</p>
        <Link
          to="/"
...
const StyledWrapper = styled.div`
  ...
  /* Note: Some hardcoded colors are intentional for the decorative TV animation effect */
  min-height: 100vh;
  width: 100vw;
