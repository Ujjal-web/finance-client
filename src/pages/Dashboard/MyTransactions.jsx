        ...
        {sortedTransactions.map((txn) => (
          ...
          >
            <div className="flex justify-between items-center mb-3">
              <h3
                className={`text-xl font-bold ${txn.type === "Income" ? "text-secondary" : "text-accent"
                  }`}
              >
                {txn.type}
              </h3>
              {txn.type === "Income" ? (
                <ArrowUpCircle className="text-secondary" size={28} />
              ) : (
                <ArrowDownCircle className="text-accent" size={28} />
              )}
            </div>
